...
def scrape_data(year):
    ...
    file_output = open(PATH+'Year/Players/fantasy_'+str(year)+'.csv', 'w')
    file_output.writelines(header+'\n')

    for i in range(1,24):
        driver.get(
            f"https://www.footywire.com/afl/footy/dream_team_round?year={year}&round={i}&p=&s=T")
        ...
        rows = 1+len(driver.find_elements("xpath",
            "//div[@id='dream-team-round-div']/table/tbody/tr"))
        ...
        for r in range(2, rows):
            ...
            player = driver.find_element("xpath",
                "//div[@id='dream-team-round-div']/table/tbody/tr["+str(r)+"]/td[2]").text
            team = driver.find_element("xpath",
                "//div[@id='dream-team-round-div']/table/tbody/tr["+str(r)+"]/td[3]").text
            score = driver.find_element("xpath",
                "//div[@id='dream-team-round-div']/table/tbody/tr["+str(r)+"]/td[6]").text
